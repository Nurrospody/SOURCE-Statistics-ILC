...
**Monday** - 1 hour 38 minutes - created new timecard; added 3 direct links to README and fixed Week 10 timecard link which wasn't working.  Started list of what to do with garden data once I've finished collecting it, since I've thought about it but the thoughts have just been floating this whole time.  Worked on Chapter 6 report and apply(), lapply(), sapply() commands.
