---
title: "Vocabulary, Basic Maths, & Basic Scripts: Chapter 3 *Learn R for Applied Statistics : With Data Visualizations, Regressions, and Statistics* (Started Week 2 Monday)"
author: "Nurrospody"
date: "4/6/2020"
output:
  github_document:
...
This chapter is very long; most chapters in this book will continue to be too long to be put into one report reasonably.  I have seperated this chapter into seperate reports, roughly based on the amount of content showed per section.
