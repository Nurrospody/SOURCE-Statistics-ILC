...
[LINK]() to the *.sav* file.  It looks very satisfying with all its new fancy headers!  
...
I tried read.spss using the .sav file format, .spss format, .sps format, even the .txt format, but I always got this type of error: Error in read.spss(file = "spfox.sav", to.data.frame = TRUE) : 
  ...
  I'm not sure what's up, especially since it knits perfectly fine in my Rmd file.  I'll revisit it later when it's more important.