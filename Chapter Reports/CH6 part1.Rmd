...
I downloaded a sample dataset for using with ANOVA, [crop.data.csv]().  This dataset has 4 different variables about growing crops: density of crops, which block it was in, which fertilzer was used, and what the yield's weight was.  (no unit is offered, but probably pounds).  
...
This is the test that we could not do without fertilzer being a factor, that I mentioned earlier.  
